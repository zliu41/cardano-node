...
data NodeConfiguration
  = NodeConfiguration
      {  ncSocketConfig    :: !SocketConfig
       ...
       , ncTracerSocketMode :: !(Maybe (SocketPath, ForwarderMode))
...
data PartialNodeConfiguration
  = PartialNodeConfiguration
      {  pncSocketConfig    :: !(Last SocketConfig)
       ...
       , pncTracerSocketMode :: !(Last (SocketPath, ForwarderMode))
...
makeNodeConfiguration pnc = do
  ...
  return $ NodeConfiguration
             ...
             , ncTracerSocketMode = getLast $ pncTracerSocketMode pnc
